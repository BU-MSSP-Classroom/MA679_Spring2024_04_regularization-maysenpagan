...
```{r,echo=TRUE}
#new data set
new_2008 <- ames_raw_2008 %>% select(SalePrice, `Overall Qual`, FoundationBrkTil, FoundationCBlock, FoundationPConc, FoundationSlab, FoundationStone, FoundationWood, `Year Remod/Add`, `TotRms AbvGrd`, `Lot Area`, `Garage Cars`)
new_2008 <- na.omit(new_2008)
#choose best lambda using CV
f <- as.formula(SalePrice ~ `Overall Qual` + FoundationBrkTil + FoundationCBlock + FoundationPConc + FoundationSlab + FoundationStone + FoundationWood + `Year Remod/Add` + (`TotRms AbvGrd`*`Lot Area`) + (`Garage Cars`*`Lot Area`))
