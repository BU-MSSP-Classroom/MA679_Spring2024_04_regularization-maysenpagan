...
Your code:
```{r,echo=TRUE}
lmfit_2008<- lm(log(SalePrice) ~ `Overall Qual` + FoundationBrkTil + FoundationCBlock + FoundationPConc + FoundationSlab + FoundationStone + FoundationWood + `Year Remod/Add` + (`TotRms AbvGrd`*`Lot Area`) + (`Garage Cars`*`Lot Area`), data = ames_raw_2008)
